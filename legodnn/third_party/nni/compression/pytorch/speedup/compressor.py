...
from legodnn.third_party.nni.common.graph_utils import build_module_graph
from legodnn.third_party.nni.compression.pytorch.utils.mask_conflict import fix_mask_conflict
from legodnn.third_party.nni.compression.pytorch.utils.utils import get_module_by_name
...
class ModelSpeedup:
    ...
    def _random_model_input(self, dummy_input, confidence, batch_dim):
        ...
        if isinstance(dummy_input, torch.Tensor):
            ...
            dummy_input = dummy_input[0]  ## gxy modify
