...
from legodnn.third_party.nni.compression.pytorch.quantization.literal import QuantType, BN_FOLD_OP, BN_FOLD_TAG
from legodnn.third_party.nni.compression.pytorch.quantization.observers import RecordingObserver
