...
from legodnn.third_party.nni.algorithms.compression.v2.pytorch.base import Pruner, BasePruningScheduler, Task, TaskResult
from legodnn.third_party.nni.compression.pytorch.speedup import ModelSpeedup
