...
from legodnn.third_party.nni.experiment import Experiment, ExperimentConfig
from legodnn.third_party.nni.algorithms.compression.pytorch.auto_compress.interface import AbstractAutoCompressionModule
