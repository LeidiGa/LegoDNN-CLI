...
from legodnn.third_party.nni.compression.pytorch.utils.config_validation import QuantizerSchema
from legodnn.third_party.nni.compression.pytorch.compressor import BN_FOLD_TAG, Quantizer, QuantForward, QuantGrad
from legodnn.third_party.nni.compression.pytorch.quantization.literal import (
    PER_CHANNEL_QUANT_SCHEME,
    QuantScheme,
    QuantDtype,
    QuantType
)
from legodnn.third_party.nni.compression.pytorch.quantization.observers import default_weight_observer, default_histogram_observer
from legodnn.third_party.nni.compression.pytorch.quantization.settings import LayerQuantSetting
from legodnn.third_party.nni.compression.pytorch.quantization.utils import (
    calculate_qmin_qmax,
    get_bits_length,
    get_min_max_value,
    get_quant_shape
