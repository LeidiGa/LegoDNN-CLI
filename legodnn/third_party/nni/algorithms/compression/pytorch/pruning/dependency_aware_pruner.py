...
from legodnn.third_party.nni.common.graph_utils import TorchModuleGraph
from legodnn.third_party.nni.compression.pytorch.utils.shape_dependency import ChannelDependency, GroupDependency
from legodnn.third_party.nni.compression.pytorch.utils.config_validation import PrunerSchema
from legodnn.third_party.nni.compression.pytorch.compressor import Pruner
...
class DependencyAwarePruner(Pruner):
    ...
    def validate_config(self, model, config_list):
        schema = PrunerSchema([{
            ...
            Optional('op_types'): Or(['Conv2d'], ['Conv2d', 'ConvTranspose2d']),
