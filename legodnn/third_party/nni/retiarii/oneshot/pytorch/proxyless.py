...
class HardwareLatencyEstimator:
    ...
    def _form_latency_table(self, model, dummy_input, dump_lat_table):
        ...
        from legodnn.third_party.nni.retiarii.converter import convert_to_graph
        from legodnn.third_party.nni.retiarii.converter.graph_gen import GraphConverterWithShape
        from legodnn.third_party.nni.retiarii.converter.utils import flatten_model_graph_without_layerchoice, is_layerchoice_node
