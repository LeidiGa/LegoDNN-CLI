...
from legodnn.third_party.nni.retiarii.utils import uid
from legodnn.third_party.nni.retiarii.evaluator.pytorch.cgo.evaluator import MultiModelSupervisedLearningModule
