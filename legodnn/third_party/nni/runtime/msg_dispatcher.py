...
from legodnn.third_party.nni import NoMoreTrialError
from legodnn.third_party.nni.assessor import AssessResult
...
class MsgDispatcher(MsgDispatcherBase):
    ...
    def handle_report_metric_data(self, data):
        """
        data: a dict received from legodnn.third_party.nni_manager, which contains:
